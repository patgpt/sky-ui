      ...
      async (argv) => {
        ...
        await Effect.runPromise(programm)
          ...
          .catch((error) => {
            ...
            p.outro(
              `You can report this issue at: ${color.underline(color.cyan('https://github.com/patgpt/sky-ui/issues/new'))}`,
            )
          })
      },
    )
