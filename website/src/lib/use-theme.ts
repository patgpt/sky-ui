import type { AccentColor, ColorPalette, GrayColor, Radius } from '@sky-ui/panda-preset'
import { createVariables } from '@sky-ui/panda-preset/utils'
...
const loadColorPalette = async (color: string): Promise<ColorPalette> => {
  const palettes: Record<string, () => Promise<{ default: ColorPalette }>> = {
    amber: () => import('@sky-ui/panda-preset/colors/amber'),
    blue: () => import('@sky-ui/panda-preset/colors/blue'),
    bronze: () => import('@sky-ui/panda-preset/colors/bronze'),
    brown: () => import('@sky-ui/panda-preset/colors/brown'),
    crimson: () => import('@sky-ui/panda-preset/colors/crimson'),
    cyan: () => import('@sky-ui/panda-preset/colors/cyan'),
    gold: () => import('@sky-ui/panda-preset/colors/gold'),
    grass: () => import('@sky-ui/panda-preset/colors/grass'),
    green: () => import('@sky-ui/panda-preset/colors/green'),
    indigo: () => import('@sky-ui/panda-preset/colors/indigo'),
    iris: () => import('@sky-ui/panda-preset/colors/iris'),
    jade: () => import('@sky-ui/panda-preset/colors/jade'),
    lime: () => import('@sky-ui/panda-preset/colors/lime'),
    mauve: () => import('@sky-ui/panda-preset/colors/mauve'),
    mint: () => import('@sky-ui/panda-preset/colors/mint'),
    neutral: () => import('@sky-ui/panda-preset/colors/neutral'),
    olive: () => import('@sky-ui/panda-preset/colors/olive'),
    orange: () => import('@sky-ui/panda-preset/colors/orange'),
    pink: () => import('@sky-ui/panda-preset/colors/pink'),
    plum: () => import('@sky-ui/panda-preset/colors/plum'),
    purple: () => import('@sky-ui/panda-preset/colors/purple'),
    red: () => import('@sky-ui/panda-preset/colors/red'),
    ruby: () => import('@sky-ui/panda-preset/colors/ruby'),
    sage: () => import('@sky-ui/panda-preset/colors/sage'),
    sand: () => import('@sky-ui/panda-preset/colors/sand'),
    sky: () => import('@sky-ui/panda-preset/colors/sky'),
    slate: () => import('@sky-ui/panda-preset/colors/slate'),
    teal: () => import('@sky-ui/panda-preset/colors/teal'),
    tomato: () => import('@sky-ui/panda-preset/colors/tomato'),
    violet: () => import('@sky-ui/panda-preset/colors/violet'),
    yellow: () => import('@sky-ui/panda-preset/colors/yellow'),
  }
...
const syncAccentColor = async (color: AccentColor) => {
  ...
  const styleStyle = document.querySelector<HTMLStyleElement>('#sky-ui-accent')
...
const syncGrayColor = async (color: GrayColor) => {
  ...
  const styleStyle = document.querySelector<HTMLStyleElement>('#sky-ui-gray')
  if (!styleStyle) return
