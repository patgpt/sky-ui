...
description: Bring the Sky UI semantic to your entire application
---

## Colors

Sky UI's theme primarily revolves around one gray and one accent color. These foundational colors are later utilized to
...
// live
<Box bg="bg.muted" p="2">
  <Text size="sm">Hello from Sky UI</Text>
</Box>
```
