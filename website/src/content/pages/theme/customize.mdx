...
id: customize
title: Customize
description: Learn how to customize the Sky UI Preset
---

This guide will walk you through the different ways you can customize Sky UI to fit your brand.

## Presets

Sky UI was built with customization in mind. By adding the `@sky-ui/panda-preset` into your Panda configuration,
...
> Since **Sky UI** uses [Radix Colors](https://www.radix-ui.com/colors) under the hood, you can use their [tool](https://www.radix-ui.com/colors/custom) to generate your custom color palette.
...
import { defineConfig } from '@pandacss/dev'
import { createPreset } from '@sky-ui/panda-preset'
import { createPreset } from '@sky-ui/panda-preset/colors/sand'
...
A powerful way to customize Sky UI is by adjusting
[semantic tokens](https://sky-ui.yellowdog.digital/docs/panda/theme/semantic-tokens). This is helpful if you want to modify specific
...
As of `v0.44`, the `@sky-ui/panda-preset` no longer includes component recipes.
